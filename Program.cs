    ...
    class Program
    {
        ...
        public void CreateTabel()
        {
            ...
            try
            {
                ...
                SqlCommand cm = new SqlCommand("create table Penyewa (Kode_Penyewa char(5) not null primary key, Nama_Penyewa varchar(50) not null unique, Alamat_Penyewa varchar(255), No_KTP_Penyewa char(10), No_Telp_Penyewa char(10), Jenis_Kelamin char(1))"+
